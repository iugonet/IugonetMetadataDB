...
// calculate community depth
        int depth=0;
        Community cc=c, parent;

        do{
          parent = cc.getParentCommunity();
          cc = parent;
          depth++;
        } while(parent != null);
        ...
        if (depth == 3)
        {
             ...
             out.println("<a class=\"trigger\" id=\"c" + treeid[treeid.length-1]  + "\" href=\"javascript:void(0)\" onclick=\"treeindex2('h" + id.replaceAll("/", "") + "', 'c" + treeid[treeid.length-1] + "'); return false\">open item</a>");
        }
        ...
        if (cols.length > 0)
        {
            if (id.equals("")){
                ...
                out.println("<ul id=\"h" + id.replaceAll("/", "") + "\" style=\"display:none;\">");
            }

...
//      System.out.println("strDisplayMode = [" + strDisplayMode + "]");
        // Null Trap
        ...
        // Map Each JSP
        // (full_nobody.jsp is the Original by N.UMEMURA. It does not include HTML Code.)
        if (strDisplayMode.equals("1")) {
            JSPManager.showJSP(request, response, "/browse/full_nobody.jsp");
        }
        else {
            JSPManager.showJSP(request, response, "/browse/full.jsp");
        }

            ...
            String lang)
    {
        ...
        for (DCValue dcv : getMetadata())
        {
            if (match(schema, element, qualifier, lang, dcv))
            {
                ...
                // START: ADD by N.UMEMURA, 20120626
                copy.metadata_value_id = dcv.metadata_value_id;
//              System.out.println("Item.java ##DEBUG> dcv.metadata_value_id = [" + dcv.metadata_value_id + "]");
                // END: ADD by N.UMEMURA, 20120626
                values.add(copy);
            }
        }
                        ...
                        while (tri.hasNext())
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    // START: Add by N.UMEMURA, 20120626
                                    dcv.metadata_value_id = resultRow.getIntColumn("metadata_value_id");
//                                  System.out.println("Item.java ##DEBUG> metadata_value_id = [" + resultRow.getIntColumn("metadata_value_id") + "]");
                                    // END: Add by N.UMEMURA, 20120626
